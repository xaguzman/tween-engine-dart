...
class CatmullRom extends TweenPath {
  ...
  num _compute(num t, List<num> points, int pointsCnt) {
    ...
    if (segment == pointsCnt - 2) {
      return _catmullRomSpline(points[pointsCnt - 3], points[pointsCnt - 2],
          points[pointsCnt - 1], points[pointsCnt - 1], t);
    }

    return _catmullRomSpline(points[segment - 1], points[segment],
        points[segment + 1], points[segment + 2], t);
  }
