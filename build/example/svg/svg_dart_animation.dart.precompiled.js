...
["dart.dom.html", "dart:html", , W, {
  ...
  Element: {
    ...
    set$attributes: function(receiver, value) {
      ...
      for (t1 = value.get$keys(), t2 = t1._map, t1 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), [H.getTypeArgumentByIndex(t1, 0)]), t1._cell = t1._map._first; t1.moveNext$0();) {
...
["dart.dom.svg", "dart:svg", , P, {
  ...
  GeometryElement: {
    "^": "GraphicsElement;",
    "%": "SVGCircleElement|SVGLineElement|SVGPathElement|SVGPolygonElement|SVGPolylineElement;SVGGeometryElement"
  },
  GraphicsElement: {
    "^": "SvgElement;",
  ...
  RectElement: {
    "^": "GeometryElement;rx=,ry=,width=,x=,y=",
    $isRectElement: true,
    "%": "SVGRectElement"
  },
  SvgElement: {
...
["", "svg_dart_animation.dart", , Y, {
  "^": "",
  main: [function() {
    var t1, rectangle, temp, temp0, t2, tl, t3;
    $.Tween__combinedAttrsLimit = 2;
    $.get$Tween__registeredAccessors().$indexSet(0, C.Type_nD4, new Y.RectAccessor());
    t1 = J.get$onClick$x(document.querySelector("#btnToggle"));
    ...
    t1 = J.get$children$x(document.querySelector("#svg"));
    rectangle = H.interceptedTypeCast(t1.get$first(t1), "$isRectElement");
    temp = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    t1 = J.getInterceptor$x(temp);
    t1.set$attributes(temp, P.LinkedHashMap_LinkedHashMap$_literal(["x", "50", "y", "100", "rx", "20", "ry", "20", "width", "250", "height", "150"], null, null));
    temp0 = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    t2 = J.getInterceptor$x(temp0);
    t2.set$attributes(temp0, P.LinkedHashMap_LinkedHashMap$_literal(["x", "0", "y", "50", "rx", "20", "ry", "20", "width", "350", "height", "250"], null, null));
    $._tweenManager = new B.TweenManager(H.setRuntimeTypeInfo([], [B.BaseTween]), false);
    tl = $.get$Timeline__pool().get$0();
    tl._setup$1(1);
    tl.beginParallel$0();
    t3 = B.Tween_to(rectangle, 1, 0);
    t3.set$targetValues([J.get$value$x(J.get$baseVal$x(t1.get$x(temp))), J.get$value$x(J.get$baseVal$x(t1.get$y(temp)))]);
    tl.push$1(t3);
    t3 = B.Tween_to(rectangle, 2, 0);
    t3.set$targetValues([t1.get$rx(temp).baseVal.value, t1.get$ry(temp).baseVal.value]);
    tl.push$1(t3);
    t3 = B.Tween_to(rectangle, 5, 0);
    t3.set$targetValues([t1.get$width(temp).baseVal.value, temp.height.baseVal.value]);
    tl.push$1(t3);
    tl.end$0();
    tl.beginParallel$0();
    t3 = B.Tween_to(rectangle, 1, 0.5);
    t3.set$targetValues([J.get$value$x(J.get$baseVal$x(t2.get$x(temp0))), J.get$value$x(J.get$baseVal$x(t2.get$y(temp0)))]);
    tl.push$1(t3);
    t3 = B.Tween_to(rectangle, 2, 0.5);
    t3.set$targetValues([t2.get$rx(temp0).baseVal.value, t2.get$ry(temp0).baseVal.value]);
    tl.push$1(t3);
    t3 = B.Tween_to(rectangle, 5, 0.5);
    t3.set$targetValues([t2.get$width(temp0).baseVal.value, temp0.height.baseVal.value]);
    tl.push$1(t3);
    tl.end$0();
    if (tl._isStarted === true)
      H.throwExpression(P.Exception_Exception("You can't change the repetitions of a tween or timeline once it is started"));
    tl._repeatCnt = -1;
    tl._repeatDelay = 0;
    tl._isYoyo = true;
    tl.start$1(0, $._tweenManager);
    C.Window_methods.get$animationFrame(window).then$1(Y.update$closure());
  }, "call$0", "main$closure", 0, 0, 1],
  update: [function(delta) {
    var t1 = J.$sub$n(delta, $.lastUpdate);
    if (typeof t1 !== "number")
      return t1.$div();
    $.lastUpdate = delta;
    if (!$._paused)
      $._tweenManager.update$1(t1 / 1000);
    C.Window_methods.get$animationFrame(window).then$1(Y.update$closure());
  }, "call$1", "update$closure", 2, 0, 6],
  main_closure: {
    "^": "Closure:10;",
  ...
  RectAccessor: {
    ...
    getValues$3: function(target, tweenType, returnValues) {
      ...
      switch (tweenType) {
        case 1:
          J.setRange$3$ax(returnValues, 0, 2, [target.x.baseVal.value, target.y.baseVal.value]);
          return 2;
        case 2:
          J.setRange$3$ax(returnValues, 0, 2, [target.rx.baseVal.value, target.ry.baseVal.value]);
          return 2;
        case 3:
          t1 = target.width.baseVal.value;
          if (0 >= returnValues.length)
            return H.ioore(returnValues, 0);
          returnValues[0] = t1;
          return 1;
        case 4:
          t1 = target.height.baseVal.value;
          if (0 >= returnValues.length)
            return H.ioore(returnValues, 0);
          returnValues[0] = t1;
          return 1;
        case 5:
          J.setRange$3$ax(returnValues, 0, 2, [target.width.baseVal.value, target.height.baseVal.value]);
          return 2;
      }
    },
    setValues$3: function(target, tweenType, newValues) {
      ...
      switch (tweenType) {
        case 1:
          ...
          t1.value = newValues[0];
          t1 = target.y.baseVal;
          if (1 >= t2)
            return H.ioore(newValues, 1);
          t1.value = newValues[1];
          break;
        case 2:
          t1 = target.rx.baseVal;
          t2 = newValues.length;
          if (0 >= t2)
            return H.ioore(newValues, 0);
          t1.value = newValues[0];
          t1 = target.ry.baseVal;
          if (1 >= t2)
            return H.ioore(newValues, 1);
          t1.value = newValues[1];
          break;
        case 3:
          t1 = target.width.baseVal;
          if (0 >= newValues.length)
            return H.ioore(newValues, 0);
          t1.value = newValues[0];
          break;
        case 4:
          t1 = target.height.baseVal;
          if (0 >= newValues.length)
            return H.ioore(newValues, 0);
          t1.value = newValues[0];
          break;
    ...
    static: {"^": "RectAccessor_XY,RectAccessor_RXRY,RectAccessor_W,RectAccessor_H,RectAccessor_WH"}
  }
},
1],
["tweenengine", "package:tweenengine/tweenengine.dart", , B, {
  ...
  Quad: {
    ...
    static: {"^": "Quad_IN,Quad_OUT,Quad_INOUT", Quad__computeINOUT: [function(t) {
        ...
        if (typeof t1 !== "number")
          return H.iae(t1);
        return -0.5 * t1;
      }, "call$1", "Quad__computeINOUT$closure", 2, 0, 7]}
  },
  CatmullRom: {
    "^": "TweenPath;compute",
  ...
  Timeline: {
    ...
    $isTimeline: true,
    static: {"^": "Timeline__poolCallback,Timeline__pool"}
  },
  closure3: {
    "^": "Closure:21;",
    call$1: function(obj) {
  ...
  closure: {
    ...
    call$0: function() {
      var t1, t2, t3, t4, t5;
      t1 = Array($.Tween__combinedAttrsLimit);
      t1.fixed$length = init;
      t1 = H.setRuntimeTypeInfo(t1, [P.num]);
      ...
      t4 = Array($.Tween__combinedAttrsLimit);
      t4.fixed$length = init;
      t4 = H.setRuntimeTypeInfo(t4, [P.num]);
...
C.Type_nD4 = H.createRuntimeType('RectElement');
$.libraries_to_load = {};
...
function dart_precompiled($collectedClasses) {
  ...
  AnimatedLength.prototype.get$baseVal = function(receiver) {
  ...
  AnimatedLengthList.prototype.get$baseVal = function(receiver) {
    return receiver.baseVal;
  };
  ...
  AnimatedNumber.prototype.get$baseVal = function(receiver) {
    return receiver.baseVal;
  };
  ...
  EllipseElement.prototype.get$rx = function(receiver) {
    return receiver.rx;
  };
  EllipseElement.prototype.get$ry = function(receiver) {
    return receiver.ry;
  };
  ...
  RectElement.prototype.get$rx = function(receiver) {
    return receiver.rx;
  };
  RectElement.prototype.get$ry = function(receiver) {
    return receiver.ry;
  };
  ...
  function RectAccessor() {
  }
  RectAccessor.builtin$cls = "RectAccessor";
  if (!"name" in RectAccessor)
    RectAccessor.name = "RectAccessor";
  $desc = $collectedClasses.RectAccessor;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RectAccessor.prototype = $desc;
  function BaseTween() {
  }
